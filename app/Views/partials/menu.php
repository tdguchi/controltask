...
<div id="scrollbar">
    <div class="container-fluid">
        ...
        <span class="text-capitalize"><a href="#" onclick="loadModalContent('<?= site_url('tareas/fichar') ?>');" class="btn btn-warning text-dark" data-bs-toggle="modal" data-bs-target="#ajax">Fichar</a></span>
