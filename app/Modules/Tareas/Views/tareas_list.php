                                    ...
                                    <table class="table align-middle table-nowrap">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                <th class="sort text-capitalize "><a href="<?php echo $accion . '?ob=' . sentidobusquedacrd('horasestimadas', 'tareas.') . $filter . $custom_title; ?>" style="color:inherit;">Estimado <span class="block-sort"><i class="bx <?= $orden_campo == "horasestimadas" ? ($orden_dir == "ASC" ? "bx-caret-up active" : "bx-caret-down active") : "bxs-sort-alt" ?>"></i></span></a></th>
                                                <th class="sort text-capitalize "><a href="<?php echo $accion . '?ob=' . sentidobusquedacrd('horasreales', 'tareas.') . $filter . $custom_title; ?>" style="color:inherit;">Dedicado <span class="block-sort"><i class="bx <?= $orden_campo == "horasreales" ? ($orden_dir == "ASC" ? "bx-caret-up active" : "bx-caret-down active") : "bxs-sort-alt" ?>"></i></span></a></th>
                                                <? if (count($group_id) == 2) { ?>
                                        ...
                                        <tbody class="list form-check-all">
                                            <? foreach ($tareas_data as $row) { ?>
                                                <tr <?= ($row->estado == 1) ? 'bgcolor=#FFD28E' : (($row->estado == 2) ? 'bgcolor=#FF8F8E' : 'bgcolor="#D8FAE0"' ) ?>>
                                                    <th scope="row">
                                                        <div class="form-check">
