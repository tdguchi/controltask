                                                    ...
                                                    <td class=" text-right ">
                                                        <? if ($quien === '1' && $fichado === true) { ?>
                                                            ...
                                                            <? } else if ($row->estado == 1) { ?>
                                                                <button onclick="loadModalContent('<?= site_url('worklog/update/1') ?>')" data-bs-toggle="modal" data-bs-target="#ajax" id="1" title="Pausar tarea" class="btn" value="1"><i class="bx bx-pause fs-22"></i></button>
                                                            <? }
                                                            if ($row->estado != 2) { ?>
