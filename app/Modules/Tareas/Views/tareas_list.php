                                    ...
                                    <table class="table align-middle table-nowrap">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                <? } ?>
                                                <th class="sort text-capitalize "><a href="<?php echo $accion . '?ob=' . sentidobusquedacrd('horasreales', 'tareas.') . $filter . $custom_title; ?>" style="color:inherit;">HR <span class="block-sort"><i class="bx <?= $orden_campo == "horasreales" ? ($orden_dir == "ASC" ? "bx-caret-up active" : "bx-caret-down active") : "bxs-sort-alt" ?>"></i></span></a></th>
                                        ...
                                        <tbody class="list form-check-all">
                                            <? foreach ($tareas_data as $row) { ?>
                                                <tr>
                                                    ...
                                                    <td class=" text-right "><?=date('d H:i:s',$row->horasestimadas) ?></td>
                                                    <? if (count($group_id) == 2) { ?>
