...
class Worklog_model extends Model
{
    ...
    {
        $builder = $this->db->table($this->table)->select('SUM(TIME_TO_SEC(fechacierre) - TIME_TO_SEC(fechainicio)) AS diferencia');
    ...
    function get_limit_data($limit, $start = 0, $q = NULL, $tab = NULL, $oc = '', $od = '', $filter = array())
    {
        ...
        $builder->join('tareas', 'tareas.tarea_id = worklog.tarea_id', 'left');
