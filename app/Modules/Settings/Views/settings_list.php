                    ...
                    <div class="card card-list-soaga">
                        <div class="card-header border-0">
                            <div class="d-flex align-items-center">
                                ...
                                <?php if ($fichado === true) { ?>
                                    <span class="text-capitalize"><a title="Añadir settings" href="#" onclick="loadModalContent('<?= site_url('settings/create/1') ?>');" class="btn btn-green add-btn" data-bs-toggle="modal" data-bs-target="#ajax"><i class="ri-add-line align-bottom me-1"></i> Añadir <?= $titulo ?></a></span>
                                    <?php } ?>
                        ...
                        <div class="card-body">
                            <div>
                                        ...
                                        <thead class="table-light">
                                            <tr>
                                                <th class="sort text-capitalize ">
                                                    <a title="Clave" href="<?php echo site_url('settings/view?ob=' . sentidobusquedacrd('key', 'settings.')) . $filter . $custom_title; ?>" style="color:inherit;">Clave <span class="block-sort"><i class="bx <?= $orden_campo == "key" ? ($orden_dir == "ASC" ? "bx-caret-up active" : "bx-caret-down active") : "bxs-sort-alt" ?>"></i></span></a>
                                                </th>
                                                <th class="sort text-capitalize "><a title="valor" href="<?php echo site_url('settings/view?ob=' . sentidobusquedacrd('value', 'settings.')) . $filter . $custom_title; ?>" style="color:inherit;">Valor <span class="block-sort"><i class="bx <?= $orden_campo == "value" ? ($orden_dir == "ASC" ? "bx-caret-up active" : "bx-caret-down active") : "bxs-sort-alt" ?>"></i></span></a></th>
                                                <th class="sort text-capitalize "><a title="descripcion" href="<?php echo site_url('settings/view?ob=' . sentidobusquedacrd('description', 'settings.')) . $filter . $custom_title; ?>" style="color:inherit;">Descripción <span class="block-sort"><i class="bx <?= $orden_campo == "description" ? ($orden_dir == "ASC" ? "bx-caret-up active" : "bx-caret-down active") : "bxs-sort-alt" ?>"></i></span></a></th>
                                            </tr>
                                        </thead>
                                                    ...
                                                    <?php if ($fichado === true) { ?>
                                                            <ul class="list-inline list-inline-dashed tasks-list-menu mb-0">
                                                                <li class="list-inline-item fs-12">
                                                                    <a title="editar" href="#" onclick="loadModalContent('<?= site_url('settings/update/' . $row->key) ?>/1')" data-bs-toggle="modal" data-bs-target="#ajax">Editar</a>
                                                                </li>
                                                            </ul>
                                                        <?php } ?>
                                                        </div>
                                ...
                                <div class="d-flex align-items-center">
                                    <div title="total settings" class="mb-0 flex-grow-1">
