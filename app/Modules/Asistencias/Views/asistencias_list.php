                                            ...
                                            <? foreach ($asistencias_data as $row) { ?>
                                                <tr>
                                                    ...
                                                    <? if ($row->asistenciatipo_id == 0) { ?>
                                                        <span style="color:green" ><i class='bx bx-exit bx-rotate-180 fs-22' ></i> <?= $row->tipo?> </span>
                                                    <? } else { ?>
                                                        <span style="color:green" ><i style="color:red" class='bx bx-exit fs-22' ></i> <?= $row->tipo?> </span>
                                                    <? } ?>
                                                </td>
