                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-shrink-0">
                                    <form id="search-box" class="input-group" action="<?php echo site_url('asistencias/view'); ?>" method="post">
                                        <input id="Date" class="form-control" id="p" name="p" type="date" value="<?= $p ?>" />
                            ...
                            <div>
                                    ...
                                    <table class="table align-middle table-nowrap">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                <th class="sort text-capitalize "><a href="<?php echo site_url('asistencias/view?ob=' . sentidobusquedacrd('usuario_id', 'asistencias.')) . $filter . $custom_title; ?>" style="color:inherit;">Operador <span class="block-sort"><i class="bx <?= $orden_campo == "usuario_id" ? ($orden_dir == "ASC" ? "bx-caret-up active" : "bx-caret-down active") : "bxs-sort-alt" ?>"></i></span></a></th>
                                                <th class="sort text-capitalize "><a href="<?php echo site_url('asistencias/view?ob=' . sentidobusquedacrd('asistenciatipo_id', 'asistencias.')) . $filter . $custom_title; ?>" style="color:inherit;">Tipo De Asistencia <span class="block-sort"><i class="bx <?= $orden_campo == "asistenciatipo_id" ? ($orden_dir == "ASC" ? "bx-caret-up active" : "bx-caret-down active") : "bxs-sort-alt" ?>"></i></span></a></th>
                                                <th class="sort text-capitalize "><a href="<?php echo site_url('asistencias/view?ob=' . sentidobusquedacrd('fechahora', 'asistencias.')) . $filter . $custom_title; ?>" style="color:inherit;">Fecha Hora <span class="block-sort"><i class="bx <?= $orden_campo == "fechahora" ? ($orden_dir == "ASC" ? "bx-caret-up active" : "bx-caret-down active") : "bxs-sort-alt" ?>"></i></span></a></th>
                                                <th class="sort text-capitalize "><a href="<?php echo site_url('asistencias/view?ob=' . sentidobusquedacrd('comentario', 'asistencias.')) . $filter . $custom_title; ?>" style="color:inherit;">Comentario <span class="block-sort"><i class="bx <?= $orden_campo == "comentario" ? ($orden_dir == "ASC" ? "bx-caret-up active" : "bx-caret-down active") : "bxs-sort-alt" ?>"></i></span></a></th>
                                            </tr>
                                        </thead>
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="mb-0 flex-grow-1">
                                        <?= $total_rows > count($asistencias_data) ? (count($asistencias_data) . " de ") : "" ?><?= $total_rows ?> registro<?= $total_rows != 1 ? "s" : ""?> . <?='Tu jornada para este dia ha sido de: ' .  gmdate("Hhimss", $totalhoras) ?>
                                    </div>
