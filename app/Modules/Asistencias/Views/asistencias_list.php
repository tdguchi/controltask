                    ...
                    <div class="card card-list-soaga">
                        <div class="card-header border-0">
                            <div class="d-flex align-items-center">
                                <h5 class="card-title mb-0 flex-grow-1 h5-title"><?= $titulo ?> <?= $element . ' del ' ?> <?= $p != null ? date('N d-m-Y',strtotime($p)) : date('N d-m-Y') ?></h5>
                                    ...
                                    <table class="table align-middle table-nowrap">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                <th class="sort text-capitalize "><a href="<?php echo site_url('asistencias/view?ob=' . sentidobusquedacrd('fechahora', 'asistencias.')) . $filter . $custom_title; ?>" style="color:inherit;">Hora <span class="block-sort"><i class="bx <?= $orden_campo == "fechahora" ? ($orden_dir == "ASC" ? "bx-caret-up active" : "bx-caret-down active") : "bxs-sort-alt" ?>"></i></span></a></th>
