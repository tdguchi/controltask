                                    ...
                                    <table class="table align-middle table-nowrap">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                <th class="sort text-capitalize "><a href="<?php echo site_url('asistencias/view' . $modal . '/' . $quien . '?ob=' . sentidobusquedacrd('comentario', 'asistencias.')) . $filter . $custom_title; ?>" style="color:inherit;">Comentario <span class="block-sort"><i class="bx <?= $orden_campo == "comentario" ? ($orden_dir == "ASC" ? "bx-caret-up active" : "bx-caret-down active") : "bxs-sort-alt" ?>"></i></span></a></th>
                                            </tr>
                                        </thead>
