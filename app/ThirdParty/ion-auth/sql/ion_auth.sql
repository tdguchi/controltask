...
INSERT INTO `ion_users` (`id`, `ip_address`, `username`, `password`, `email`, `activation_code`, `forgotten_password_code`, `created_on`, `last_login`, `active`, `first_name`, `last_name`, `company`, `phone`) VALUES
     ('1','127.0.0.1','teconsite','$2y$10$UE00Q9GjlHOyo1XVQRTQeuUww5LmaBMzsK.EcrTj.8IOZa.mo/Eoy','desarrollo@teconsite.com','',NULL,'1268889823','1268889823','1', 'Admin','istrator','ADMIN','0');
...
CREATE TABLE `ion_users_groups` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_ion_users_groups_users1_idx` (`user_id`),
  KEY `fk_ion_users_groups_groups1_idx` (`group_id`),
  CONSTRAINT `uc_ion_users_groups` UNIQUE (`user_id`, `group_id`),
