						...
						<div class="card mt-4 card-login">
							...
							<div class="card-body">
								<div class="text-center mt-2">
									<h5 class="color-green">He olvidado mi Contraseña</h5>
									<p class="text-muted">Por favor, introduce tu Usuario para que podamos enviarte un email para restablecer tu contraseña.</p>
								...
								<div class="p-2 mt-4">
									<form action="<?= base_url('auth/forgot_password') ?>" method="post" accept-charset="utf-8" class="form-soaga">
										...
										<div class="mt-4">
											<button class="btn btn-black w-100" type="submit">Enviar</button>
										</div>
