						...
						<div class="card mt-4 card-login">
							...
							<div class="card-body">
								<div class="text-center mt-2">
									<h5 class="color-green">Cambiar Contraseña</h5>
								...
								<div class="p-2 mt-4">
									...
									<?= csrf_field() ?>
										...
										<div class="mb-3">
											<label for="new"><?= sprintf(lang('Auth.change_password_new_password_label'), $minPasswordLength) ?></label>
											<input type="password" id="new" name="new" class="form-control" value="" tabindex="1">
										</div>
										<div class="mb-3">
											<label for="new_confirm" class="form-label"><?= lang('Auth.change_password_new_password_confirm_label') ?></label>
											<input type="password" id="new_confirm" name="new_confirm" class="form-control" value="" tabindex="1">
										</div>
										<?php echo form_input($user_id); ?>
										<button class="btn btn-black w-100" type="submit" tabindex="4"><?= lang('Auth.change_password_submit_btn') ?></button>
