...
class IonAuth extends \CodeIgniter\Config\BaseConfig
{
	...
	public $tables = [
		'users'          => 'ion_users',
		'groups'         => 'ion_groups',
		'users_groups'   => 'ion_users_groups',
		'login_attempts' => 'ion_login_attempts',
	];
	...
	public $bcryptAdminCost     = 10;        // Cost for user in admin group
	 ...
	 */
	public $siteTitle                = 'controltask.net';       // Site Title, example.com
	public $adminEmail               = 'info@controltask.net'; // Admin Email, admin@example.com
